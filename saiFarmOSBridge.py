"""FarmOS telemetry bridge for Sensorius.

MVP behavior:
- Listens to new readings written by saiDataLogger.
- Queues events in-memory.
- Sends each event to farmOS as a log bundle entry (default: observation).
- Supports either a pre-shared bearer token or OAuth password grant.
"""
