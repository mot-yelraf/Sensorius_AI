...
SENSOR_MODULES = {
    "dummy": ("sensorius.sensor_modules.sensor_template",  "SensorTemplate"),
    "test":  ("sensorius.sensor_modules.sensor_template",  "SensorTemplate"),
    "aht":   ("sensorius.sensor_modules.sensor_aht",    "AHTSensor"),
    "aht10": ("sensorius.sensor_modules.sensor_aht",    "AHTSensor"),
    "ahtx0": ("sensorius.sensor_modules.sensor_aht",    "AHTSensor"),
    "aqi":   ("sensorius.sensor_modules.sensor_aqi",    "AQISensor"),
    "bme680": ("sensorius.sensor_modules.sensor_aqi",    "AQISensor"),
    "bme688": ("sensorius.sensor_modules.sensor_aqi",    "AQISensor"),
    ...
    "apvpd": ("sensorius.sensor_modules.sensor_apvpd",  "VPDPlantSensor"),
    "veml":  ("sensorius.sensor_modules.sensor_veml",   "VEML7700Sensor"),
}
