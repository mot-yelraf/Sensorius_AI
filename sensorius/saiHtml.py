...
def render_dashboard(sensor_id, sensor, available, all_values, all_stats, mqtt_ingest, switch_controllers=None, sensor_locations=None, gauge_config=None, gauge_size="Small", expected_gauge_map=None, expected_display_style_map=None, display_style=None, astro_payload=None, biodynamic_payload=None, weather_forecast_provider="met_no", weather_forecast_theme="pollinator", dashboard_background_theme="leaf", dashboard_metric_set="Pick 6"):
    ...
    yield ".caelus-lunar-footer{position:absolute;left:1.35rem;right:1.35rem;bottom:.7rem;display:flex;justify-content:space-between;color:#aec3c3;font-size:.62rem;}"
    yield ".caelus-lunar-footer strong{color:#efbd65;}"
    yield ".caelus-lunar-footer small{color:rgba(235,247,240,.46);}"
    ...
    yield "@media (max-width:760px){.caelus-moon-overlay{padding:.35rem}.caelus-moon-dialog{width:100%;max-height:96vh}.caelus-lunar-layout{grid-template-columns:1fr;gap:.8rem;padding:1rem .65rem 2.5rem}.caelus-lunar-side{width:100%;max-width:34rem;margin:0 auto}.caelus-lunar-current{order:0}.caelus-lunar-side-left{order:-1}.caelus-lunar-side-right{order:1}.caelus-lunar-footer small{display:none}}"
    ...
    yield "      <div class='caelus-lunar-footer'><span>☀ Sunrise <strong id='caelusMoonSunrise'>--</strong></span><span>Sunset <strong id='caelusMoonSunset'>--</strong> ◐</span><small id='caelusMoonUpdated'>Updated --</small></div>"
    yield "    </div>"
    yield "  </section>"
    yield "</div>"
    yield "</div>"
    ...
    yield "  const altitude = Number(moon.moon_altitude);"
