...
SENSOR_MODULES = {
    ...
    "bme680": ("sensor_modules.sensor_aqi",    "AQISensor"),
    "bme688": ("sensor_modules.sensor_aqi",    "AQISensor"),
    "co2":   ("sensor_modules.sensor_co2",    "CO2Sensor"),
    "scd30": ("sensor_modules.sensor_co2",    "CO2Sensor"),
    "scd4x": ("sensor_modules.sensor_co2",    "CO2Sensor"),
    "vpd":   ("sensor_modules.sensor_vpd",    "VPDSensor"),
    "avpd":  ("sensor_modules.sensor_vpd",    "VPDSensor"),
    "bme280": ("sensor_modules.sensor_vpd",    "VPDSensor"),
