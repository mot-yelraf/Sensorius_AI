...
def render_dashboard(sensor_id, sensor, available, all_values, all_stats, mqtt_ingest, switch_controllers=None, sensor_locations=None, gauge_config=None, gauge_size="Small", expected_gauge_map=None, display_style=None):
    ...
    yield ".astro-box{display:flex;align-items:flex-start;justify-content:flex-start;background:#ffffe0;border:1px solid #ccc;border-radius:10px;padding:.45rem .55rem;min-height:160px;box-sizing:border-box;}"
    ...
    yield ".bio-modal .modal-body{padding:1rem;background:#fffdf6;display:grid;grid-template-columns:minmax(0,1fr) 230px;gap:1rem;}"
    ...
    yield ".bio-modal-side{display:flex;flex-direction:column;gap:.55rem;}"
    ...
    yield "@media (max-width: 760px){.dash-top-row{grid-template-columns:1fr;justify-items:center}.dash-left-col,.dash-right-col,.dash-side-col{display:block;width:100%;align-items:center}#sunPathCanvas{width:184px;height:86px}.astro-times{width:184px}.astro-card{min-width:120px}.dash-loc-form,.astro-box{min-height:unset}#sunBox .astro-card,#moonBox .astro-card,#bioBox .astro-card,.dash-loc-form{width:206px;min-width:206px}.moon-layout{grid-template-columns:max-content 78px max-content;column-gap:.14rem}#moonPhaseCanvas{width:78px;height:78px}.moon-side{font-size:.6rem}#moonMeta{font-size:.64rem}.bio-day{min-height:22px;height:22px}.bio-modal .modal-body{grid-template-columns:1fr}.bio-note-input{min-height:120px}}"
    yield "</style>"
