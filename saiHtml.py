...
def render_dashboard(sensor_id, sensor, available, all_values, all_stats, mqtt_ingest, switch_controllers=None, sensor_locations=None, gauge_config=None, gauge_size="Small", expected_gauge_map=None, display_style=None):
    ...
    yield ".bio-note-input{width:100%;min-height:160px;resize:vertical;border:1px solid #c8ccd0;border-radius:8px;padding:.55rem;font:inherit;background:#fff;box-sizing:border-box;}"
    yield ".bio-summary-output{width:100%;min-height:184px;border:1px solid #c8ccd0;border-radius:8px;padding:.55rem;background:#fff;box-sizing:border-box;font:inherit;white-space:pre-wrap;overflow-wrap:anywhere;line-height:1.35;color:#27313a;}"
