...
def render_dashboard(sensor_id, sensor, available, all_values, all_stats, mqtt_ingest, switch_controllers=None, sensor_locations=None, gauge_config=None, gauge_size="Small", expected_gauge_map=None, expected_display_style_map=None, display_style=None, astro_payload=None, biodynamic_payload=None):
    ...
    yield ".bio-day{min-height:31px;height:31px;border:1px solid #d7d0bf;border-radius:6px;padding:0;background:#fff;overflow:hidden;display:flex;align-items:center;justify-content:center;}"
    ...
    yield ".bio-note-input{width:100%;height:58px;max-height:58px;resize:none;overflow-y:auto;border:1px solid #c8ccd0;border-radius:8px;padding:.65rem;font-size:.625rem;line-height:1.3;background:#fff;box-sizing:border-box;text-align:left;}"
    ...
    yield "    setTimeout(() => scheduleLayoutRefresh(reason, sig), 1000);"
    yield "    return;"
    yield "  }"
