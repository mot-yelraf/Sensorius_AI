...
def render_dashboard(sensor_id, sensor, available, all_values, all_stats, mqtt_ingest, switch_controllers=None, sensor_locations=None, gauge_config=None, gauge_size="Small", expected_gauge_map=None, expected_display_style_map=None, display_style=None, astro_payload=None, biodynamic_payload=None):
    ...
    yield ".bio-status{display:flex;align-items:center;justify-content:center;gap:.14rem;width:min(100%,156px);align-self:center;padding:.24rem .3rem;border-radius:8px;border:0;background:#fffdf6;overflow:hidden;box-sizing:border-box;}"
    yield ".bio-main{display:flex;flex-direction:column;align-items:center;gap:.08rem;min-width:0;flex:1 1 auto;overflow:hidden;text-align:center;}"
