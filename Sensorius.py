...
from saiEmailNotifications import EmailNotificationService
...
async def main():
    ...
    email_notifications = EmailNotificationService(settings=settings, data_logger=data_logger, supervisor=supervisor)
    ...
    supervisor.add(email_notifications.run, name="Email Notifications", fatal_on_timeout=False, fatal_on_error=False)
